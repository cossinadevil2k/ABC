var DatetimeUtils = function(date_settings) {
	...
	this.yesterdayString = moment().subtract(1, 'days').format(this.DBFORMAT);
	this.tomorrowString = moment().add(1, 'days').format(this.DBFORMAT);
	...
	this.calcNextDate = function(start_date, date_mode, date_settings){
		...
		switch(date_mode){
			case 'day':
				...
				break;
			case 'week':
				start_date = moment(start_date, this.DBFORMAT).add(1, 'weeks').format(this.DBFORMAT);
				data.start_date = this.calcFirstDayOfWeek(start_date);
				data.end_date = this.addDay(data.start_date, 6);
				break;
			case 'month':
				start_date = moment(start_date, this.DBFORMAT).add(1, 'months').format(this.DBFORMAT);
				data.start_date = this.calcFirstDayOfMonth(start_date, date_settings);
				data.end_date = this.calcEndDayOfMonth(data.start_date);
				break;
			case 'quarter':
				start_date = moment(start_date, this.DBFORMAT).add(1, 'quarters').format(this.DBFORMAT);
				...
				break;
			case 'year':
				start_date = moment(start_date, this.DBFORMAT).add(1, 'years').format(this.DBFORMAT);
	...
	this.calcPreviousDate = function(start_date, date_mode, date_settings){
		...
		switch(date_mode){
			case 'day':
				...
				break;
			case 'week':
				start_date = moment(start_date, this.DBFORMAT).subtract(1, 'weeks').format(this.DBFORMAT);
				data.start_date = this.calcFirstDayOfWeek(start_date);
				data.end_date = this.addDay(data.start_date, 6);
				break;
			case 'month':
				start_date = moment(start_date, this.DBFORMAT).subtract(1, 'months').format(this.DBFORMAT);
				data.start_date = this.calcFirstDayOfMonth(start_date, date_settings);
				data.end_date = this.calcEndDayOfMonth(data.start_date);
				break;
			case 'quarter':
				start_date = moment(start_date, this.DBFORMAT).subtract(1, 'quarters').format(this.DBFORMAT);
				data.start_date = this.calcFirstDayOfQuarter(start_date, date_settings);
				date.end_date = this.calcEndDayOfQuarter(data.start_date);
				break;
			case 'year':
				start_date = moment(start_date, this.DBFORMAT).subtract(1, 'years').format(this.DBFORMAT);
				data.start_date = this.calcFirstDayOfYear(start_date, date_settings);
				data.end_date = this.calcEndDayOfYear(data.start_date);
				break;
		}
	...
	this.calcEndDayOfQuarter = function(start_date) {
		return moment(start_date, this.DBFORMAT).add(3, 'month').subtract(1, 'days').format(this.DBFORMAT);
	};
	...
	this.calcEndDayOfYear = function(start_date) {
		return moment(start_date, this.DBFORMAT).add(1, 'years').subtract(1, 'days').format(this.DBFORMAT);
	};
	...
	this.calcEndDayOfMonth = function(start_date) {
		return moment(start_date, this.DBFORMAT).add(1, 'months').subtract(1, 'days').format(this.DBFORMAT);
	};
	...
	this.addDay = function(start_date, num) {
		return moment(start_date, this.DBFORMAT).add(num, 'days').format(this.DBFORMAT);
	};

	this.subtractDay = function(start_date, num) {
		return moment(start_date, this.DBFORMAT).subtract(num, 'days').format(this.DBFORMAT);
	};

	this.addMonth = function(start_date, num) {
		return moment(start_date, this.DBFORMAT).add(num, 'months').format(this.DBFORMAT);
	};

	this.subtractMonth = function(start_date, num) {
		return moment(start_date, this.DBFORMAT).subtract(num, 'months').format(this.DBFORMAT);
	};

	this.addYear = function(start_date, num) {
		return moment(start_date, this.DBFORMAT).add(num, 'years').format(this.DBFORMAT);
	};

	this.subtractYear = function(start_date, num) {
		return moment(start_date, this.DBFORMAT).subtract(num, 'years').format(this.DBFORMAT);
	};
